locals {
  ...
  codedeploy_app_name = data.terraform_remote_state.app.outputs.app_name
  codedeploy_dg_name  = data.terraform_remote_state.dg.outputs.dg_name
  ...
  codepipeline_source_config = {
    ...
    FullRepositoryId = "hongjunjeong95/devops_sample_app_python"
    BranchName       = "master"
  }
